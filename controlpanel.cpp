...
void ControlPanel::setupLayout()
{
    ...
    modeLayout -> addLayout(groupFacesLayout = new QHBoxLayout);
    ...
    groupFacesLayout -> addWidget(new QLabel(tr("Mesh Name")));
    groupFacesLayout -> addWidget(meshNameEdit = new QLineEdit(tr("")));
    groupFacesLayout -> addWidget(groupFacesButton = new QPushButton(tr("Group Faces")));
