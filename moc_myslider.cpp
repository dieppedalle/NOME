...
QT_MOC_LITERAL(1, 9, 17), // "paramValueChanged"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 11) // "changeValue"

    },
    "MySlider\0paramValueChanged\0\0changeValue"
};
...
void MySlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->paramValueChanged((*reinterpret_cast< float(*)>(_a[1]))); break;
        ...
        {
            typedef void (MySlider::*_t)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MySlider::paramValueChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MySlider::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MySlider.data,
...
// SIGNAL 0
void MySlider::paramValueChanged(float _t1)
{
