...
struct qt_meta_stringdata_SliderWindow_t {
    QByteArrayData data[4];
    char stringdata0[39];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SliderWindow_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SliderWindow_t qt_meta_stringdata_SliderWindow = {
    {
QT_MOC_LITERAL(0, 0, 12), // "SliderWindow"
QT_MOC_LITERAL(1, 13, 18), // "sliderValueChanged"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 5) // "value"

    },
    "SliderWindow\0sliderValueChanged\0\0value"
};
...
const QMetaObject SliderWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_SliderWindow.data,
      qt_meta_data_SliderWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SliderWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SliderWindow.stringdata0))
